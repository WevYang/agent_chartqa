...
def apply_ulysses_patch(model_type: str) -> None:
    ...
    if model_type in ("qwen3_vl", "qwen3_vl_moe"):
        ...
        from transformers.models.qwen3_vl_moe.modeling_qwen3_vl_moe import Qwen3VLMoeForConditionalGeneration, Qwen3VLMoeModel
    ...
    if model_type in ("llama", "gemma", "gemma2", "mistral", "qwen2", "qwen2_moe", "qwen3", "qwen3_moe"):
        return
